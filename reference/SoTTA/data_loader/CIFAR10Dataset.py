...
class CIFAR10Dataset(torch.utils.data.Dataset):
    ...
    def __init__(self, domains=None, activities=None, transform='none', domain_label=0):
    ...
    def preprocessing(self):
        ...
        self.domain_labels = np.array([self.domain_label for _ in range(len(self.features))])
